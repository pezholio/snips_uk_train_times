...
class TestGetTimes(object):
    ...
    @vcr.use_cassette('fixtures/vcr_cassettes/gets_times.yaml')
    ...
    @vcr.use_cassette('fixtures/vcr_cassettes/returns_error.yaml')
    ...
    @vcr.use_cassette('fixtures/vcr_cassettes/with_delay.yaml')
